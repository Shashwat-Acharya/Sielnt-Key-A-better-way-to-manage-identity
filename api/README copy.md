...
A QR code labeled clearly as a one‑time identity request

Q17. What does the user do?
A:

Scans the QR code using any available phone

Authenticates locally using biometrics
...
Identity Initialization Module

Local Authorization (Biometric Gate) Module

Cross‑Device Challenge Module

Verification & Response Module

Recovery & Continuity Module
